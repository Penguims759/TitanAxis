...
public class AlertaService {
    ...
    private final TransactionService transactionService; // ADICIONADO
    ...
    public AlertaService(ProdutoRepository produtoRepository, TransactionService transactionService) { // ALTERADO
        this.produtoRepository = produtoRepository;
        this.transactionService = transactionService; // ADICIONADO
    }
    ...
    public List<String> gerarMensagensDeAlerta() {
        ...
        // ALTERADO: Acesso aos dados agora ocorre dentro de uma transação
        return transactionService.executeInTransactionWithResult(em -> {
            List<Produto> todosProdutos;
            try {
                todosProdutos = produtoRepository.findAllIncludingInactive(em);
            } catch (Exception e) {
            ...
            for (Produto p : todosProdutos) {
                // Acessa os lotes que já foram carregados com o produto
